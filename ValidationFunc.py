...
# Event
multiplicity_var = PlotVar('MCNu_Multiplicity', 'N Reco Targets in Event', 'Frac. of MCParticles', [0,50], 50)    
shower_multiplicity_var = PlotVar('MCNu_ShowerMultiplicity', 'N Reco Targets in Event', 'Frac. of MCParticles', [0,100], 50)
...
Track_MCP_plotting_vars = [michel_n_mc_hits_2d_var, michel_completeness_var, michel_purity_var, michel_true_vis_energy]
Track_track_shower_vars = [michel_n_mc_hits_2d_var]
Track_efficiency_vars = [michel_n_mc_hits_2d_var, michel_true_vis_energy]
...
shower_initial_completeness = PlotVar('BM_InitialCompleteness', 'Initial Completeness', 'Frac. of True Showers', [-1.0,1.0], 20) # -1 == no MC hits in initial region
shower_initial_purity = PlotVar('BM_InitialPurity', 'Initial Purity', 'Frac. of True Showers', [-1.0,1.0], 20)                   # -1 == no MC hits in initial region
